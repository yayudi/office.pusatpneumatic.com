  ...
  <div class="space-y-6 animate-fade-in">
    ...
    >
      <div>
        ...
        <p class="text-sm text-text/50 mt-1">
          Data sebaran aset gudang, valuasi barang, dan top kontributor aset.
        </p>
      </div>
    ...
    <StatsFilterBar
      ...
      :hasActiveAdvancedFilters="
        !!filterValues.building.length || filterValues.stockStatus !== 'all' || filterValues.purpose
      "
    >
      <template #main>
      ...
      >
        ...
        >
          <div class="p-4 bg-secondary/5">
            <span class="text-xs font-bold text-text/50 uppercase block mb-1"
              >Total SKU Tampil</span
            >
          ...
          <div class="p-4 bg-primary/5 col-span-2 md:col-span-2 items-center flex justify-between">
            <div>
              <span class="text-xs font-bold text-primary/70 uppercase block mb-1"
                >Total Nilai Keseluruhan</span
              >
          ...
          <table class="w-full text-left text-sm whitespace-nowrap">
              ...
              <tr>
                ...
                >
                  <div class="flex items-center justify-center gap-2">
                    Total Stok
                    <font-awesome-icon
                      :icon="getSortIcon('total_quantity')"
            ...
            <tbody class="divide-y divide-secondary/20">
              ...
              <template v-else>
                ...
                >
                  <td
                    class="px-4 py-3 font-medium text-text bg-background/50 border-r border-secondary/10 w-auto"
                  >
                    {{ item.sku }}
                  </td>
                  <td class="px-4 py-3 w-full">
                    <div
                      class="whitespace-normal leading-tight font-medium text-text/90"
                      :title="item.name"
                    >
                      {{ item.name }}
                    </div>
      ...
      <main class="flex-1 w-full min-w-0" v-else>
        ...
        <div class="flex justify-end mb-4 animate-fade-in" v-if="statisticsList.length > 0">
          <div class="flex items-center gap-3 w-64">
            <span class="text-sm font-semibold text-text/70 whitespace-nowrap"
              >Tampilkan Peringkat:</span
            >
            <BaseSelect
              v-model="chartMaxCap"
        ...
        <!-- Chart Dashboard -->
        <div
          class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in md:pb-12"
        ...
        >
          ...
          <p class="text-text/60 mt-2 text-sm max-w-sm">
            Jalankan filter untuk memuat ulang tabel komputasi valuasi.
          </p>
        </div>
      </main>
    </div>
