      ...
      <div class="flex-1 overflow-hidden flex flex-col">
        ...
        <div v-if="activeTab === 'export'" class="flex-1 flex flex-col h-full overflow-hidden">
          <p class="text-sm text-text/70 mb-4 shrink-0 font-medium">
            Download data terbaru untuk diedit. Pilih format Excel untuk kemudahan atau CSV untuk
            kompatibilitas.
          </p>
        ...
        <div v-if="activeTab === 'import'" class="flex-1 flex flex-col h-full overflow-hidden">
          <p class="text-sm text-text/70 mb-4 shrink-0 font-medium">
            Upload file master produk yang sudah Anda edit. Sistem akan memproses pembaruan secara
            massal.
          </p>
          ...
          >
            ...
            <div class="flex-1">
              ...
              <p class="text-xs text-text/70 mt-1.5 leading-relaxed font-medium">
                Sistem akan melakukan simulasi upload untuk mengecek validitas data dan menampilkan
                error jika ada, <strong>tanpa menyimpan perubahan apapun</strong> ke database.
              </p>
            </div>
          </label>
